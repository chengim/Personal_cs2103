...
public class CityConnect {
	...
	public static String executeCommand(String userCommand) {
		...
		return performCorrectCommand(userCommand, commandType);
		/*
		 * ==============NOTE TO STUDENTS======================================
	...
	private static String performCorrectCommand(String userCommand, COMMAND_TYPE commandType) throws Error {
		switch (commandType) {
		case ADD_ROUTE:
